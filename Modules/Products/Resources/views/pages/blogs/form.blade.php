<form method="post" action="{{ $action }}" enctype="multipart/form-data">
    ...
    <div class="form-group {{ has_error($errors,"content") }}">
        <div class="row">
            ...
            <div class="col-10">
                <textarea class="form-control form-control-sm" id="editor" name="content" placeholder="Mô tả sách"
    ...
    <div class="form-group {{ has_error($errors,"tag") }}">
        <div class="row">
            ...
            <div class="col-10">
                <input name='tag' class="w-100 rounded-1" value='{{ old_input("tag",$item ?? []) }}'>
